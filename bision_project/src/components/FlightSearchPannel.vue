<template>
  <!-- <div class="flight-search-wrapper"> -->
      ...
      <div style="padding: 20px;">
              <div class="searchpannel-radio-group">
              ...
              <div class="searchpannel-airport">
                  <div class="departure">
                      <label> 출발지
                          <input
                              type="text"
                              placeholder="국가, 도시 또는 공항"
                              class="left-end-input right-end-input"
                  ...
                  <div class="searchpannel-changevalue" @click="changeAirport()">
                  ...
                  <div class="destination">
                      <label> 도착지
                          <input
                              ...
                              placeholder="국가, 도시 또는 공항"
                              class="right-end-input left-end-input"
                ...
                <div class="flight-search-info">
                  <div class="duration-start" @click="openCalender('.leavingDate', '.leavingDate-picker')">
                      <label> 가는날
                          <input  class="searchpannel-leavingDate" type="text" :placeholder="todayDate" :value="leavingDate" disabled>
...
<script>
import './FlightSearchPannel.css'
import airportList from './AirportList'
import Autocomplete from './Autocomplete'

export default {
    name: 'FlightSearchPannel',
    components: {
        Autocomplete,
    },
    data() {
