    ...
    <div class="FlightDetail__dialog">
      ...
      <div class="FlightDetail__body">
        ...
        <div class="secondSection">
          <div class="costInfo">
            <h2>최저가로 예약하기</h2>
            <div v-for="(option, idx) in flight.Options">
              <div class="fakeHr" v-if="idx!=0"> </div>
              <div class="book">
                <a :href="option.DeeplinkUrl" target="_blank"><div class="overlay"></div></a>
                <div class="bookBox">
                  <div class="agentsName">{{option.AgentsName}}에서 예약</div>
                  <div class="bookLink">
                    <div>
                      <img width="100px" :src="option.AgentsImageUrl" alt="">
                    </div>
                    <div class="price" >
                      <img v-if="idx==0" src="../assets/ticket.png" height="40px"alt="best price">
                      <h2>{{flight.CurrencySymbol}}{{option.Price}}</h2>
                    </div>
                  </div>
                </div>
              </div>
              <div class="readBeforeBooking" v-if="idx==0">
                <div class="fakeHr"> </div>
                <div class="readBeforeBooking__Title" @click="isRBBVisible = !isRBBVisible">
                  <div style="display:flex; align-items:center;"><i class="material-icons">notification_important</i>&nbsp;<h4 style="display:inline-block;">예약전에 확인해주세요. </h4></div>
                ...
                <div class="readBeforeBooking__Toggle"  v-if="isRBBVisible">
