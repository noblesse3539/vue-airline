        ...
        <div class="FlightDetail__body">
          <div class="flightinfo">
            ...
            <div class="ticket" @click="isInVisible = !isInVisible" @mouseover="inArrow = true" @mouseleave = "inArrow = false">
              ...
              <v-icon v-if="isInVisible" color="#35c235" large>fa-chevron-up</v-icon>
              <v-icon v-if="!isInVisible" :color="`${inArrow? '#35c235':'grey'}`" large>fa-chevron-down</v-icon>
            </div>
            ...
            <div class="ticket" @click="isOutVisible = !isOutVisible"  @mouseover="outArrow = true" @mouseleave = "outArrow = false">
              ...
              <v-icon v-if="isOutVisible" color="#35c235" large>fa-chevron-up</v-icon>
              <v-icon v-if="!isOutVisible" :color="`${outArrow? '#35c235':'grey'}`" large>fa-chevron-down</v-icon>
            </div>
          ...
          <div class="ad">
           <div class="costInfo">
              <h2>최저가로 예약하기</h2>
                <a class="book" :href="flight.LowestDeeplinkUrl" target="_blank">
                  <img width="100px" :src="flight.LowestAgentsImageUrl" alt="">
                  <h1>{{flight.CurrencySymbol}}{{flight.LowestPrice}}</h1>
                </a>
