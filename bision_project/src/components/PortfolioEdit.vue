...
export default {
  ...
  data (){
    return{
      ...
      currency: [],
      dateOption: false,
      titleLabel: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.title : '제목을 입력해주세요.',
      dateOption: true,
      dbTags:['액티비티', '공연관람'],
      showTags:[],
      checkText:'',
      check : false,
      validate: false,
      tempMain: this.$props.serviceInfoFuck ?  this.$props.serviceInfoFuck.mainImg : 'https:\/\/i.imgur.com\/9ge6Osc.jpg',
      nation: [],
      nationSelected: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.nation_kor : '',
      city: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.city_kor : [],
      ...
      complete: false,
      tourProgram: {
        guide : this.$props.serviceInfoFuck ?  this.$props.serviceInfoFuck.guide : '',
        title: this.$props.serviceInfoFuck ?  this.$props.serviceInfoFuck.title : '',
        mainImg: this.$props.serviceInfoFuck ?  this.$props.serviceInfoFuck.mainImg : '',
        nation_kor: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.nation_kor : '',
        city_kor: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.city_kor : [],
        fromDate: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.fromDate : '',
        toDate: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.toDate : '',
        duration: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.duration : '',
        refund: {
          refund100:  this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.refund100 : 1,
          refund50:  this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.refund50 : 0,
          refund30:  this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.refund30 : 0
        },
        desc: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.desc : '',
        options:[],
        tags: [],
        detail: this.$props.serviceInfoFuck ? this.$props.serviceInfoFuck.detail : '',
      },
      option:{
          guideservice: '',
          title: '',
  ...
  mounted:function(){
    ...
    if (this.$props.serviceInfoFuck) {
      this.$props.serviceInfoFuck.tags.map( tag => {
  ...
  methods : {
    ...
    isProps() {
      if (this.$props.serviceInfoFuck !== undefined) {
        console.log("ok")
        return true
      } else {
        console.log("no")
